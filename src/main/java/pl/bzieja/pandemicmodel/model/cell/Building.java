...
public enum Building {
    ...
    KRAKUS			(10, new Color(Integer.parseInt("80477e", 16))),
    TERRACE_KRAKUS	(10, new Color(Integer.parseInt("80478e", 16))),
    NAWOJKA			(10, new Color(Integer.parseInt("80479e", 16))),
    OBIEZYSWIAT		(10, new Color(Integer.parseInt("2f2943", 16))),
    MENSA			(10, new Color(Integer.parseInt("2f2945", 16))),

    B9      (20, new Color(Integer.parseInt("80471e", 16))),
    B7      (20, new Color(Integer.parseInt("80472e", 16))),
    B5      (20, new Color(Integer.parseInt("80473e", 16))),
    ...
    H_A2    (20, new Color(Integer.parseInt("2f2920", 16))),
    H_A1    (20, new Color(Integer.parseInt("2f2921", 16))),
    A0      (20, new Color(Integer.parseInt("2f2922", 16))),
    A2      (20, new Color(Integer.parseInt("2f2923", 16))),
    A1      (20, new Color(Integer.parseInt("2f2924", 16))),
    C1      (20, new Color(Integer.parseInt("2f2925", 16))),
    C2      (20, new Color(Integer.parseInt("2f2926", 16))),
    C3      (20, new Color(Integer.parseInt("2f2927", 16))),
    U1      (20, new Color(Integer.parseInt("2f2928", 16))),

    C4      (20, new Color(Integer.parseInt("2f2929", 16))),
    C6      (20, new Color(Integer.parseInt("2f2930", 16))),
    C5      (20, new Color(Integer.parseInt("2f2931", 16))),
    A4      (20, new Color(Integer.parseInt("2f2932", 16))),
    ...
    B1      (20, new Color(Integer.parseInt("2f2936", 16))),
    P_B1B2  (20, new Color(Integer.parseInt("2f2937", 16))),
    B2      (20, new Color(Integer.parseInt("2f2938", 16))),
    ...
    E_LEARNING_CENTER      (20, new Color(Integer.parseInt("2f2944", 16))),
    D4      (20, new Color(Integer.parseInt("2f2946", 16))),
    MEDICAL_CENTER      (20, new Color(Integer.parseInt("2f2947", 16))),
    B8      (20, new Color(Integer.parseInt("2f2948", 16))),
